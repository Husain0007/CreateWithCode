...
The **fifth Prototype** has the goal of creating a User Interface around an arcade style game. The game includes 3 difficulty settings. The game spawns two types of items. The first are balls that increase points, and the second are bombs that end the game.
